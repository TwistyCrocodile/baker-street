        ...
        <div>
          ...
          <div className="mt-11 grid grid-cols-1 gap-3 min-[430px]:grid-cols-2">
            {aboutFeatures.map(({ title, Icon }) => (
              <div
                key={title}
                className="min-h-28 rounded-[8px] border border-baker-line bg-baker-cream/80 p-5 transition duration-300 hover:-translate-y-1 hover:shadow-soft sm:min-h-32"
              >
